...
- **Drop support for Node.js 6 and 7:** Only Node.js 8 oder newer are fully supported and tested for compatibility with tus-js-client from now own. Earlier versions may work but we don't guarantee it. Please note that we still support the same browsers as before.
